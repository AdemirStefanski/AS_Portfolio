...
//             <motion.div
//               className="rounded-md border-2 border-my-colors-menu-hover flex items-center drop-shadow-lg mt-8 md:mt-0 relative"
//               initial="hidden"
//               whileInView="visible"
//               viewport={{ once: true, amount: 0.5 }}
//               transition={{ delay: 0.1, duration: 0.5 }}
...
//             >
//               <div className="p-8">
//                 <div className={`text-base leading-6 pb-4 ${isSmallScreen && !isExpanded ? 'line-clamp-3' : ''}`}>
//                   {textContent}
//                 </div>
